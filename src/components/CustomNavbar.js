  ...
  return (
    <div>
      <Navbar color="primary" dark expand="md" fixed="">
        <NavbarBrand tag={ReactLink} to="/"><b>MovieBookingApp</b></NavbarBrand>
        ...
        <Collapse navbar isOpen={isOpen}>
          {login && user.role == admin ? (
            <>
              <Nav className="me-auto" navbar>
                <NavItem>
                  <NavLink tag={ReactLink} to="/addTheater"><b>Add Theater</b></NavLink>
                </NavItem>
                <NavItem>
          ...
          {!login && (
            <>
              <Nav className="ms-auto " navbar  >
                <NavItem>
                  <NavLink tag={ReactLink} to="/login"><b>Login</b></NavLink>
                </NavItem>
                <NavItem>
